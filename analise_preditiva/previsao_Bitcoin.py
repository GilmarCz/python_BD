...
# Converte e Transformar valores
for col in ['Último','Abertura','Máxima','Mínima','Vol.','Var%']:
    df_bitcoin[col] = df_bitcoin[col].str.replace('K','000').str.replace('M','000000').str.replace('B','000000000').str.replace('%','')
...
print(df_treino.tail())  # últimos registros de treino
print("\n" + "="*60 + "\n")
...
# Dividir em treino (80%) e teste (20%) de forma aleatória
